...
def register_services() -> None:
    ...
    container.register_singleton('conversation_repository',
                                 create_conversation_repository)
    container.register_singleton('vector_store', create_vector_store)
    container.register_singleton('pdf_ingest_service',
                                 create_pdf_ingest_service)

    # Register conversation manager as factory (new instance per use)
    container.register_factory('conversation_manager',
